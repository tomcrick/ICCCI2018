...
c.40\%; in other words, there were less common trends amongst places,
...
equal 1.} -- this implies that trends showing across location does not
necessarily imply the prominance or importance of activity or topic.
...
country node is to all other trend nodes; it shows that Saudi Arabia
...
identified as isolated trends. Moreover, observing originating places
...
them 1st places for trends to appear in. However, Bahrain, UAE, Qatar,
...
other places a trend is likely to reach based on the location in which
...
that first appeared in Kuwait have also appeared in one other place,
...
well in reaching other places, the number of trends it generates may
affect the total reach. For example, Qatar was highest in reaching
other places, however it was the 5th in being the origin of trends
that reach all places. This was certainly clear in the case of Saudi
Arabia: its scores in reaching other places were not comparable to its
